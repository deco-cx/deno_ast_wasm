...
// source-hash: f107d38bc0feb728d383fd6eab845ac5a66016da
let wasm;
...
const loader = new WasmBuildLoader({
  ...
  cache: isNodeOrDeno
    ? (await import(
      "https://raw.githubusercontent.com/denoland/wasmbuild/0.15.5/loader/cache.ts"
    )).cacheToLocalDir
    : undefined,
});
/**
 ...
 *   exports: { parseSync: typeof parseSync }
 * }>}
 */
